...
import { brandPartners } from "../lib/brandContent";
...
const heroSlides = [
  {
    ...
    copy: "Dress your team in style with premium shirts, jackets, and uniforms personalized with your company logo.",
  ...
  },
  {
    ...
    copy: "Make a sustainable impact with eco-conscious gifting options made from recycled and biodegradable materials.",
    href: "/eco-products",
  },
  {
    ...
    copy: "Impress clients and employees with innovative, branded tech products like wireless chargers, earbuds, and gadgets.",
  ...
  },
  {
    ...
    copy: "From stainless steel bottles to personalized mugs, our drinkware is perfect for daily use and corporate branding.",
    href: "/drink-ware",
  },
  {
    image: "/assets/banner1.webp",
    ...
    copy: "Discover a wide range of custom office bags, notebooks, and writing instruments perfect for gifting and branding.",
...
const customizeHighlights = [
  {
    icon: FiGift,
    title: "Brand-ready products",
    copy: "Choose apparel, drinkware, stationery, tech, awards, and packaging designed for logos and premium customization.",
  },
  {
    icon: FiPenTool,
    title: "Design support",
    copy: "Fast mockups, artwork checks, and production guidance so your branding looks sharp on every item.",
  },
  {
    icon: FiPackage,
    title: "Kitting & packaging",
    copy: "Build corporate kits, hamper boxes, and branded delivery experiences with finishing that feels premium.",
  },
  {
    icon: FiTruck,
    title: "Pan-India delivery",
    copy: "Reliable dispatch for events, employee kits, and client gifts across cities with tracking and support.",
  },
];
...
export default function HomePage() {
  ...
  return (
    <div className="home-page">
      <section className="home-hero">
        ...
        <div className="container home-hero__inner">
          ...
          <div className="home-hero__panel">
            <span>Branded merchandise made simple</span>
      ...
      <section className="home-section home-section--customize">
        <div className="container">
          <div className="home-section__head">
            <p className="home-kicker">Customize products</p>
            <h2>Tailor every gift to your brand, budget and event.</h2>
            <p>PrintKee helps you build branded merchandise with fast mockups, packaging, and bulk support for corporate gifting campaigns.</p>
          </div>
          <div className="home-customize-grid">
            {customizeHighlights.map((item) => {
              const Icon = item.icon;
              return (
                <article className="home-customize-card" key={item.title}>
                  <Icon aria-hidden="true" />
                  <h3>{item.title}</h3>
                  <p>{item.copy}</p>
                </article>
          ...
          <div className="home-customize__cta">
            <Link href="/customize" className="home-btn home-btn--primary">
              Start customizing your order <FiArrowRight aria-hidden="true" />
            </Link>
          </div>
        </div>
      </section>
